...
Pour les autres 3 modèles SARIMA(2,1,1)(0,1,1), SARIMA(1,1,2)(0,1,1) et SARIMA(1,1,1)(1,1,1) on accepte la blancheur des résidus comme le montre le tableau ci-dessous.

SARIMA   |      p-value         |   
-------  | -------------------- | 
211_011  | `r b112_011$p.value` |
...
plot(s111_111$residuals, col="blue", main="Résidus SARIMA(1,1,1)(1,1,1)")
```
...
plot(s112_011$residuals, col="blue", main="Résidus SARIMA(0,1,1)(0,1,1)")
```
...
plot(Traffic_SNCF,col="darkgreen",lwd=2,ylab="Nombre de Passagers",xlab="Temps",lty=2, xlim=c(1980,1981),ylim=range(c(Traffic_SNCF,predauto_111_011$lower,predauto_111_011$upper,predHW$lower,predHW$upper)))
...
série   |     X-squared        |       df           | p-value           | 
------- | ---------------------| ------------------ | ----------------- |
010     | `r tm1b$statistic`    |`r tm1$parameter`   | `r tm1$p.value`   | 
011     | `r tm2$statistic`    |`r tm2$parameter`   | `r tm2$p.value`   |
110     | `r tm3$statistic`    |`r tm3$parameter`   | `r tm3$p.value`   |
111     | `r tm4$statistic`    |`r tm4$parameter`   | `r tm4$p.value`   |
